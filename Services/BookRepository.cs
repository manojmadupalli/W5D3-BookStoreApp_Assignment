...
namespace BookStoreApp.Services
{
    ...
    {
        private readonly string? _connString = "Data Source=SUPRIYADEV\\SQLEXPRESS;Initial Catalog=BookStoreDb;Integrated Security=True;TrustServerCertificate=True;";
